...
export function ZoomControls() {
  ...
  return (
    <div
      className="absolute right-5 top-[132px] z-20 flex flex-col items-center bg-white/95 backdrop-blur-xl border border-slate-200/90 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-1 gap-1"
